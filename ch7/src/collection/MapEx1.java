...
public class MapEx1 {
	public static void main(String[] args) {
		...
		while(true) {
			...
			String id = sc.nextLine().trim(); //홍길동 입력하고 스페이스바 잘못입력 후 엔터 <== 이런경우를 방지하기 위해 .trim();으로 공백제거
			...
			// 비밀번호가 일치하면 프로그램 종료, 일치하지 않는 경우 "비밀번호가 일치하지 않습니다. 다시 입력해 주세요"
			// 메세지 출력 후 다시 password 입력받기
