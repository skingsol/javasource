 ...
 * 3. java.time.LocalDeta, java.time.LocalTime, jave.time.LocalDetaTime 클래스 ==> 8버전에서 추가
 */
...
public class CalendarEx1 {
	...
	public static void main(String[] args) {
		...
		// 추상 클래스, inteface 는 new 를 못하기때문에 자식 클래스 만들어서 사용
		
		// 현재 시스템의 날자와 시간 정보 리턴
		...
		System.out.println("올 해의 몇 주차 : "+today.get(Calendar.WEEK_OF_YEAR));
		System.out.println("이번달의 몇 주차 : "+today.get(Calendar.WEEK_OF_MONTH));
