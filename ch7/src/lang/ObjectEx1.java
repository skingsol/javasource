...
public class ObjectEx1 {
	public static void main(String[] args) {
		...
		System.out.println("obj1 toString "+obj1.toString()); //java.lang.Object@4926097b 나옴
		System.out.println("obj2 toString "+obj2.toString()); //java.lang.Object@762efe5d 나옴
		
		// Value 부모 : Object 클래스
		// 부모 메소드 + Value 객체 메소드 모두 사용 가능
		Value v1 = new Value(10);
		Value v2 = new Value(10);
		System.out.println(v1.equals(v2)?"v1==v2 같음":"v1!=v2 다름");
		System.out.println("v1 toString "+v1.toString()); //lang.Value@41a4555e 나옴
		...
		// toStrings()이 오버라이딩 되어 있다면 참조변수명만 사용해도 된다.
