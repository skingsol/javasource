...
public class MemberEx {
	...
	public static void main(String[] args) {
		...
		if(member1.passwordAandConfirmPasswordEquals()) {
			//ture 라면 비밀번호가 일치합니다.
		...
		System.out.println(member2.passwordAandConfirmPasswordEquals()?"비밀번호가 일치합니다.":"비밀번호를 확인해 주세요");
	...
	static void memberInfo(Member member) {
		//출력결과
		System.out.println("아이디 : "+member.useid);//아이디 : 초기값 출력
